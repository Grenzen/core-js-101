...
function isLeapYear(date) {
  ...
  && date.getFullYear() % 400 !== 0) ? false : true;
}
...
function angleBetweenClockHands(date) {
  ...
  let angleBetweenTheHands = (0.5 * (60 * hour - 11 * minutes));
  if (angleBetweenTheHands > 180) angleBetweenTheHands = 360 - angleBetweenTheHands;
  const angleInRad = (angleBetweenTheHands * Math.PI) / 180;
